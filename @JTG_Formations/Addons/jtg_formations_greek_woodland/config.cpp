...
class CfgVehicles {
    ...
    class B_JTGGR_AH_1Z_CAS : RHS_AH1Z_wd_CS_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
        displayName = "AH-1Z (CAS)";
        side = 1;
        faction = "JTG_GR";
        crew = "B_JTGGR_Pilot";

        class Turrets : Turrets {
            class MainTurret : MainTurret { gunnerType = "B_JTGGR_Pilot"; };
        };
    ...
    class B_JTGGR_HMMWV_M2 : rhsusf_m1025_w_m2_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
        ...
        class Turrets : Turrets {
            ...
            class CargoTurret_01 : CargoTurret_01 { gunnerType = "B_JTGGR_Team_Leader"; };
            class CargoTurret_02 : CargoTurret_02 { gunnerType = "B_JTGGR_Rifleman_SAW"; };
            class CargoTurret_03 : CargoTurret_03 { gunnerType = "B_JTGGR_Rifleman_GL"; };
        };
