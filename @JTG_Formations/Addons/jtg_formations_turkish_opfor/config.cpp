            ...
            class Infantry {
                ...
                class jtgtrk_infantry_fireteam {
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_Team_Leader";
                    };
                    class Unit1 {
                        position[] = { 5 , -5 , 0 };
                        rank = "CORPORAL";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_Rifleman_SAW";
                    };
                    class Unit2 {
                        position[] = { -5 , -5 , 0 };
                        rank = "PRIVATE";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_Rifleman_AT";
                    };
                    class Unit3 {
                        position[] = { 10 , -10 , 0 };
                        rank = "PRIVATE";
                    ...
                    class Unit4 {
                        ...
                        rank = "CORPORAL";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_Rifleman_GL";
                    };
                };
                ...
                class jtgtrk_infantry_machinegun_team {
                    ...
                    class Unit1 {
                        ...
                        rank = "CORPORAL";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_Machinegunner";
                    };
                    class Unit2 {
                        position[] = { -5 , -5 , 0 };
                        rank = "PRIVATE";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_MG_Assistant";
                    };
                };
                ...
                class jtgtrk_infantry_hq {
                    ...
                    class Unit0 {
                        ...
                        rank = "CAPTAIN";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_Officer";
                    };
                    class Unit1 {
                        position[] = { 5 , -5 , 0 };
                        rank = "LIEUTENANT";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_2IC";
                    };
                    class Unit2 {
                        position[] = { -5 , -5 , 0 };
                        rank = "LIEUTENANT";
                        side = 0;
                        vehicle = "B_JTGTRK_OPF_FAC";
                    };
                };
...
class CfgVehicles {
    ...
    class JTG_TRK_OPF_infantry_rifleman : rhs_vdv_rifleman_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_Rifleman_SAW : B_JTGTRK_Rifleman_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_Rifleman_AT : JTG_TRK_OPF_infantry_rifleman {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_MG_Assistant : B_JTGTRK_Rifleman_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_Team_Leader : B_JTGTRK_Rifleman_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_Rifleman_GL : B_JTGTRK_Rifleman_OCimport_02 {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_Machinegunner : JTG_TRK_OPF_infantry_rifleman {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
    ...
    class B_JTGTRK_OPF_Officer : B_JTGTRK_OPF_Team_Leader {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
        displayName = "Officer";
    ...
    class B_JTGTRK_OPF_2IC : B_JTGTRK_OPF_Officer {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
        displayName = "2IC";
    ...
    class B_JTGTRK_OPF_FAC : B_JTGTRK_OPF_Officer {
        author = "+= rath";
        scope = 2;
        scopeCurator = 2;
        displayName = "FAC";
